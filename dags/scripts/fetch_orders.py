...
API balikin satu envelope JSON: { total_orders, orders: [...] }
Tiap order punya array products. Kita flatten jadi satu baris per (order × product),
biar gampang di-agregat sama Spark di task berikutnya.
"""
